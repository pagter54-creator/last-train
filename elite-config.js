...
(() => {
 ...
 Object.assign(D.ENEMIES,{
  ...
  commandElite:make('commandElite','사냥개 지휘차','⚑',250,.35,.65,7,'command',{radius:.35,speedBonus:.2,intervalMult:.85,windupMult:.85,orderInterval:9,orderSeconds:5,chargeBonus:.35,carDamage:2,crewDamage:1,interval:5},'주변 일반 적의 이동·공격·특수 행동을 강화합니다.'),
  fireElite:make('fireElite','방화 습격차','♨',220,.2,.85,11,'fire',{hold:.4,windup:2,interval:12,fireSeconds:10,hullRatio:.004,crewRatio:.025,flight:.65},'화재는 직원에게 위험합니다. 대피하거나 비상 장갑으로 피해를 막으세요.'),
  stealthElite:make('stealthElite','스텔스 자폭 드론','◇',150,.1,1,16,'stealth',{travel:15,currentHpRatio:.3,targetingRule:'focusOnly'},'자동 포탑이 감지하지 못합니다. 집중 사격 지정 또는 직원 개인화기로 요격하세요.')
 });
