...
(() => {
 ...
 Object.assign(D.ENEMIES,{
  ...
  bulwarkElite:make('bulwarkElite','강습 방벽차','▣',630,.6,.55,7,'bulwark',{radius:.405,armorBonus:.15,escortMin:2,escortMax:4,carDamage:3,crewDamage:1,interval:4},'효과 범위 안의 다른 적에게 장갑 +15%p를 부여합니다.'),
  ...
  commandElite:make('commandElite','사냥개 지휘차','⚑',375,.35,.65,7,'command',{radius:1.05,speedBonus:.2,intervalMult:.85,windupMult:.85,orderInterval:9,orderSeconds:5,chargeBonus:.35,carDamage:2,crewDamage:1,interval:5},'주변 일반 적의 이동·공격·특수 행동을 강화합니다.'),
