...
(() => {
  ...
  const C=window.BOSS_REWORK={
    ...
    truck:{hp:950,armor:.68,travel:17,warning:3,boarders:[2,4],boarderHp:115,carDamage:7,crewDamage:5,maxAlive:2,damageRule:{type:'max',rate:.035,legacyBase:7}},
    behemoth:{hp:14000,cannon:{warning:2.8,damage:100,damageRule:{type:'current',rate:.40,min:.10,legacyBase:100}},drive:{warning:2,seconds:8,speed:.68}},
    arachne:{hp:20500},
    grips:{
  ...
  const part=(type,name,hp,x,y,regen,extra={})=>({type,name,hp,x,y,regen,armor:.35,...extra});
  Object.assign(D.BOSSES.behemoth,{sharedHp:C.behemoth.hp,engineSpeedMult:1,summon:null,parts:[
    part('core','CORE',C.behemoth.hp,.54,.41,0,{victory:true,armor:.35}),
  ...
  Object.assign(D.BOSSES.arachne,{sharedHp:C.arachne.hp,summon:null,parts:[
    part('core','CORE',C.arachne.hp,.54,.35,0,{victory:true,armor:.35}),
