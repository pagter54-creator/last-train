...
(()=>{
 ...
 window.LAST_RAIL_ASSET_CONFIG={
  ...
  labels:{core:'핵심 시스템',act1:'ACT I',act2:'ACT II',act3:'ACT III',boss1:'BEHEMOTH',boss2:'ARACHNE',boss3:'ACT III BOSS',titan:'TITAN',events1:'ACT I 이벤트',events2:'ACT II 이벤트'},
  contentGroups:{
   acts:{act1:'act1',act2:'act2',act3:'act3'},
   bosses:{behemoth:'boss1',arachne:'boss2'},
   titan:'titan',
   events:{act1:'events1',act2:'events2',act3:'events2'}
  },
  eventImages,
  /*
