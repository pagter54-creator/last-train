...
(() => {
  ...
  const old={};for(const k of ['startBoss','updateBoss','damageEnemy','targetInRange','executeFocus','executeArmor','effectiveCarPower','crewForCar','trainDisruptionMultiplier','moveCrew','swapCrew','inspectEnemy','enemyAttack','checkBattleState'])if(g[k])old[k]=g[k].bind(g);
