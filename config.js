...
window.GAME_DATA = (() => {
  const BALANCE = {
    ...
    audio: { volume: 0.14, defaultMaster: 0.65, minInterval: 0.055, maxVoices: 24, bgmTracks: { lobby: './bgm/bgm_lobby.mp3', act1_battle: './bgm/bgm_act1_battle.mp3', act2_battle: './bgm/bgm_act2_battle.mp3', act3_battle: './bgm/bgm_act3_battle.mp3', act1_boss: './bgm/bgm_act1_boss.mp3', act2_boss: './bgm/bgm_act2_boss.mp3', act3_boss: './bgm/bgm_act3_boss.mp3', titan_boss: './bgm/bgm_titan.mp3' }, bgmGain: 0.3, bgmFadeSeconds: 1.4, windInterval: 8, railInterval: 0.8,
  ...
  const MODULES = {
    cooling: { name: '냉각 모듈', icon: '❄', price: 135, effect: 'cooling', coolingMult: 1.12, range: 1 },
